...
## BASELINE-3.5.10（冻结于 2026-09-15，**已被后续 change set 取代**）

> ⚠️ **本基线已被 #51/#52/#53 的 change set 取代**（快照 d3f73564abe69386）。
> 保留在此仅作历史记录 —— **不要再拿它当当前状态的判据**。
> 本轮改动的验证记录见 CHANGELOG 的 #51–#53 与各自 commit message。
